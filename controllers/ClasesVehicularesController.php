...
class ClasesVehicularesController extends BaseController {
     ...
     * @param string $id_clase_vehicular
     * @return mixed
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            try {
                ...
                if($createAnother == 0) {
                    ...
                    return $returnToView(new ClaseVehicular(), $model->clase_vehicular);
                }
            } 
            catch(\Exception $e) {
                $transaction->rollBack();
        ...
        if ($model->load(Yii::$app->request->post()))  {
            ...
            try {
                ...
                if($createAnother == 0) {
                    ...
                    return $returnToView(false, new ClaseVehicular(), $model->clase_vehicular);
                }
            } 
            catch(\Exception $e) {
                $transaction->rollBack();
