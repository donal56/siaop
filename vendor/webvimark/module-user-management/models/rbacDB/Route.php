...
class Route extends AbstractItem
{
	...
	{
		if(Route::isRouteAllowedInternal($route, $allowedRoutes)) {
			return true;
		}
		
		$route .= '/index';

		return Route::isRouteAllowedInternal($route, $allowedRoutes);
	}
	 ...
	 * @return boolean
	 */
	public static function isRouteAllowedInternal($route, $allowedRoutes)
	{
