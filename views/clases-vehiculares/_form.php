...
<div class="clase-vehicular-form">
    <?php $form = ActiveForm::begin(['id' => 'clase-vehicular-form']); ?>
        <div class="card">
            ...
            <div class="card-body">
                <?php  if($guardado) : ?>
                    <div class="alert alert-success" role="alert">
                        <p>Clase Vehicular <b>"<?=  $guardado ?>"</b> guardado exitosamente.</p>
                    </div>
                <?php  endif; ?>

                <div class="row my-3">
                       <?= $form->field($model, 'clase_vehicular', ['options' => ['class' => 'form-group col-sm-4']])
                ...
                <div class= "btn-page">
                    ...
                    <?php 
                        if(User::hasPermission('agregarClaseVehicular')) { 
                            echo Html::button('Guardar y crear otro', ['class' => 'btn btn-primary', 'onclick' => 'saveSimpleForm("clase-vehicular-form", true)']) . ' ';
                        }
                    ?>
