...
<div class="cliente-view">
    ...
    <div class="card">
        <div class="card-header d-block">
            ...
            <div class= "btn-page">
                <?php 
                    if(User::hasPermission('modificarCliente')) { 
                        echo Html::button(Html::a('Actualizar', ['update', 'id' => $model->id_cliente]), ['class' => 'btn btn-primary']) . " ";
                    }
                    
                    if (User::hasPermission('eliminarCliente')) { 
                        echo Html::button(Html::a('Eliminar', ['delete', 'id' => $model->id_cliente], [
                            'data' => [
