...
<div class="tipo-unidad-vehicular-form">
    <?php $form = ActiveForm::begin(['id' => 'tipo-unidad-vehicular-form']); ?>
        <div class="card">
            ...
            <div class="card-body">
                <?php  if($guardado) : ?>
                    <div class="alert alert-success" role="alert">
                        <p>Tipo Unidad Vehicular <b>"<?=  $guardado ?>"</b> guardado exitosamente.</p>
                    </div>
                <?php  endif; ?>

                <div class="row my-3">
                       <?= $form->field($model, 'tipo_unidad_vehicular', ['options' => ['class' => 'form-group col-sm-4']])
                ...
                <div class= "btn-page">
                    <?= Html::button('Guardar', ['class' => 'btn btn-success',
                        'onclick' => 'saveSimpleForm("tipo-unidad-vehicular-form", false)'
                    ]) ?>
                    <?php 
                        if(User::hasPermission('agregarTipoUnidadVehicular')) { 
                            echo Html::button('Guardar y crear otro', ['class' => 'btn btn-primary', 'onclick' => 'saveSimpleForm("tipo-unidad-vehicular-form", true)']) . ' ';
                        }
                    ?>
