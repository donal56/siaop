...
<div class="marca-view">
    ...
    <div class="card">
        <div class="card-header d-block">
            ...
            <div class= "btn-page">
                <?php 
                    if(User::hasPermission('modificarMarca')) { 
                        echo Html::button(Html::a('Actualizar', ['update', 'id' => $model->id_marca]), ['class' => 'btn btn-primary']) . " ";
                    }
                    
                    if (User::hasPermission('eliminarMarca')) { 
                        echo Html::button(Html::a('Eliminar', ['delete', 'id' => $model->id_marca], [
                            'data' => [
