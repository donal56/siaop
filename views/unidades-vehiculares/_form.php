    ...
    <?php $form = ActiveForm::begin(['id' => 'unidad-vehicular-form']); ?>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row my-3">
                    <?= $form->field($model, 'numero_identificacion_vehicular', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>
    
                    <?= $form->field($model, 'tarjeta_circulacion', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>

                    <?= $form->field($model, 'motor', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>

                    <?= $form->field($model, 'rendimiento_combustible', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['class' => 'form-control']) ?>
                </div>

                <div class="row my-3">
                    <?= $form->field($model, 'poliza', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>

                    <?= $form->field($model, 'vigencia_poliza', ['options' => ['class' => 'form-group col-sm-3']])->textInput(['class' => 'form-control']) ?>

                    <?= $form->field($model, 'permiso_ruta_sct', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>

                    <?= $form->field($model, 'numero_economica', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>
                </div>

                <div class="row my-3">
                    <?= $form->field($model, 'permiso_trp', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>

                    <?= $form->field($model, 'permiso_trme', ['options' => ['class' => 'form-group col-sm-3']])
                            ->textInput(['maxlength' => true, 'class' => 'form-control']) ?>

                    <?= $form->field($model, 'vigencia_trp', ['options' => ['class' => 'form-group col-sm-3']])->textInput(['class' => 'form-control']) ?>

                    <?= $form->field($model, 'vigencia_trme', ['options' => ['class' => 'form-group col-sm-3']])->textInput(['class' => 'form-control']) ?>
                </div>
